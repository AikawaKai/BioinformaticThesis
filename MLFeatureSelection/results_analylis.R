...
path_results <- "/home/kai/Documents/Unimi/Tesi-Bioinformatica/BioinformaticThesis/MLFeatureSelection/scores_variance/BP_results/BP_variance_70/variance_70_"
ends <- "10fcv.rda"
perf <- "perf"
